...
class KNearestNeighbor(object):
  ...
  def compute_distances_no_loops(self, X):
    ...
    X_multiplication_X_train = np.dot(X,self.X_train.T)
   
    
    dists = np.sqrt(X_square_sum[:, np.newaxis] + X_train_square_sum - 2 * X_multiplication_X_train)
