...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    # shape (N, C).                                                             #
    #############################################################################
    scores_hidden_layer = np.maximum(X.dot(W1) + b1, 0)
    ...
    out_score = out_score / N
    grads['W2'] = scores_hidden_layer.T.dot(out_score) + reg * W2
    grads['b2'] = np.sum(out_score, axis = 0)
    hidden_score = out_score.dot(W2.T)
    hidden_score = (scores_hidden_layer > 0) * hidden_score
